        ...
        <div class="col-md-8 blog-left">
            <div class="blog-info">
                <div class="blog-info-text">
                    ...
                    <p class="snglp">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor If
            ...
            <div class="coment-form">
                ...
                <form>
                    ...
                    <input type="text" value="Email (will not be published)*" onfocus="this.value = '';"
            ...
            <div class="recent-posts">
                ...
                <div class="recent-posts-info">
                    <div class="posts-left sngl-img">
                        <a href="single"> <img src="../static/images/img16.jpg" class="img-responsive zoom-img" alt=""/>
                        </a>
                    </div>
                    <div class="posts-right">
                        <label>March 5, 2015</label>
                        <h5><a href="single.jsp">Finibus Bonorum</a></h5>
                ...
                <div class="recent-posts-info">
                    <div class="posts-left sngl-img">
                        <a href="single.jsp"> <img src="../static/images/img17.jpg" class="img-responsive zoom-img"
                                                   alt=""/></a>
                    </div>
                    <div class="posts-right">
